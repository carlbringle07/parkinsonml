...
def main() -> None:
    ...
    # skillnad per split (för samma random state och n_splits blir split-indelning identisk eftersom groups=y same set)
    # Men vi kan inte garantera splittern ger exakt samma indexordning om df rader i annan ordning.
    # Så vi rapporterar bara sammanfattning + delta i medel.
