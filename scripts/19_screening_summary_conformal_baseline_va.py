# FILE: scripts/19_screening_summary_conformal_baseline_va.py
...
OUT_CSV = DATA_INDEX / "screening_summary_conformal_baseline_va_alpha0.10.csv"
...
def main():
    ...
    for split_id, (train_idx, test_idx) in enumerate(outer.split(df[feat_cols], y_all, groups)):
        ...
        # precision_pd = TP/(TP+FP) among PD decisions
