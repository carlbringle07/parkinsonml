...
DATA_ROOT = Path(r"C:\Users\ah87324\Downloads\GA\Röstinspelningar") 

# Accepterade ljudformat
...
# Taskkod sitter i början av filnamnet
...
def main() -> None:
    ...
    for group_dir in group_dirs:
        ...
        # Rekursivt och funkar även om PD har extra undermappar
