...
DATA_INDEX_DIR = Path("data_index")
FILE_INDEX_PATH = DATA_INDEX_DIR / "file_index.csv"

CACHE_DIR = DATA_INDEX_DIR / "robust_cache_vowels_pack"
CACHE_DIR.mkdir(parents=True, exist_ok=True)

OUT_PER_SPLIT = DATA_INDEX_DIR / f"robustness_conformal_screening_vowels_pack_baseline_vs_praat_alpha{ALPHA:.2f}_per_split.csv"
OUT_SUMMARY = DATA_INDEX_DIR / f"robustness_conformal_screening_vowels_pack_baseline_vs_praat_alpha{ALPHA:.2f}_summary.csv"
OUT_COMPARE = DATA_INDEX_DIR / f"robustness_conformal_screening_vowels_pack_baseline_vs_praat_alpha{ALPHA:.2f}_compare.csv"
