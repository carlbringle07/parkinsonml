# scripts/40a_conformal_class_coverage_vowels_pack_baseline.py
...
def main() -> None:
    ...
    in_path = data_dir / "features_vowels_pack_person.csv"
    ...
    n_splits = 50
    test_size = 0.30
    calib_size_within_trainval = 0.25
    ...
    out_path = data_dir / f"conformal_class_coverage_vowels_pack_alpha{alpha:.2f}.csv"
    ...
    print("=== Conformal class coverage: vowels_pack baseline (pooled) ===")
