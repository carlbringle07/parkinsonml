...
"""
Hierarkisk aggregering för vowels_pack:
1) Filnivå -> (speaker, base_task): median (robust mot outliers)
2) (speaker, base_task) -> speaker: mean över tasks (ger varje vokal/task lika vikt)

Input:
- data_index/features_vowels_pack_file.csv  (måste finnas från script 26)

Output:
- data_index/features_vowels_pack_speaker_task_hierarchical.csv
- data_index/features_vowels_pack_person_hierarchical.csv
"""
